...
<span style="color: ${dimmedTextColor}">C:\\cybertech></span> Chcesz zacząć swoją przygodę ze <span style="color: ${
...
<span style="color: ${dimmedTextColor}">C:\\cybertech></span> <span style="color: ${
    renderTheme === "green" ? "rgba(0, 255, 119, 1)" : "#f85c2c"
...
<span style="color: ${dimmedTextColor}">C:\\cybertech></span> Specjalizujemy się w <span style="color: ${
    renderTheme === "green" ? "rgba(0, 255, 119, 1)" : "#f85c2c"
